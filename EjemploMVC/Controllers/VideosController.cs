...
namespace EjemploMVC.Controllers
{
    public class VideosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Titulo,FechaEstreno,Genero,Precio")] Videos videos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Titulo,FechaEstreno,Genero,Precio")] Videos videos)
        {
            if (id != videos.ID)
            {
                return NotFound();
